...
<head>
    ...
    <style>
        ...
        *,
        ...
        button:hover {
            background-color: rgb(72 69 69 / 93%);
            color: white;
            padding: 10px 10px;
            border-radius: 8px;
        }
